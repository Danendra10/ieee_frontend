...
const Ozon = () => {
    ...
    const [Ozon, setOzon] = useState<DataElement[]>([])
    ...
    return (
        <div className="h-full flex flex-col">
            ...
            {toggleView === "map" && Ozon.length ? <Map data={Ozon} /> : null}
            {toggleView === "table" && Ozon.length ? <Table data={Ozon} /> : null}
            {Ozon.length < 1 ? <h1 className="text-3xl font-bold underline mt-80 text-center">No Data</h1> : null}
        </div>
    )
}
